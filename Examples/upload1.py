...
print()
print('LoadChar')
LoadChar = bytearray(b'\x01\x00\x06\x07\x01\x00\x01')
checksum = sum(LoadChar).to_bytes(2,'big')
Cmd_LoadChar = Header + LoadChar + bytearray(checksum)

print('Tx: ',binascii.hexlify(Cmd_LoadChar))

uart1.write(Cmd_LoadChar)
